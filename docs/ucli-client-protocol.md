...
**已部署服务端基线：** UCLI Server `0.3.0`，设备授权链接扩展合并提交 `4f71d6efdfe2504b8f72da53e1647c226bb8ff1f`，2026-08-27 已部署并验证。
...
**模型协议能力上线状态：** 服务端生产部署、Responses 通道与映射配置、UCLI 客户端实现和全链路 live smoke 均仍待完成；本文不声明其中任何一项已经完成。
