...
@Module({ controllers: [GatewayController, MetricsController], providers: [PrismaService, AuthGuard, GatewayAuthGuard, GatewayService, RedisQuotaService, ModelCatalogService] })
