...
async function loadOptions(dimension: Dimension, q = optionQuery.value, offset = 0) {
  ...
  const query = { ...draft.value, optionDimension: dimension, q, limit: '50', offset: String(offset) }
  try {
