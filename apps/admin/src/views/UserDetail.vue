...
import { api } from '../api'
import { createRequestLifecycle, grantExpiryPayload, grantStatusLabel, type ManagedUserDetail, type UserDetailGrant } from '../device-grants'
...
async function createGrant() {
  ...
  try {
    ...
    if (isCurrentRequest(generation, requestedUserId)) grantPending.value = false
  }
}
