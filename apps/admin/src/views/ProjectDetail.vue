...
type ProjectKey = { id: string; name: string; secretHint: string; account?: { displayName: string; email: string }; expiresAt: string | null; disabledAt: string | null; revokedAt: string | null; lastUsedAt: string | null; createdAt?: string }
...
<template>
  ...
  <Drawer :open="Boolean(selectedKey)" title="项目 Key 详情" description="完整密钥仅在创建时展示一次；这里查看的是安全元数据。" @close="selectedKey = null">
