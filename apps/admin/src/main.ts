...
const routes = [
  ...
  { path: '/usage-groups', redirect: '/org-units' },
  { path: '/usage-groups/:id', redirect: (to: any) => ({ path: `/org-units/${to.params.id}` }) },
  { path: '/org-units', name: 'org-units', component: () => import('./views/OrgUnits.vue') },
  { path: '/org-units/:id', name: 'org-unit-detail', component: () => import('./views/OrgUnitDetail.vue') },
